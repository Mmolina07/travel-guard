...
/// Nav flotante: 3 destinos + un único FAB central que abre "Crear viaje"
/// mediante Hero (ver HeroScaleRoute).
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _NavItem(label: 'Inicio', active: index == 0, onTap: () => onSelect(0)),
          ...
          _NavItem(
              label: 'Comercios', active: index == 2, onTap: () => onSelect(2)),
        ],
      ),
    );
  }
